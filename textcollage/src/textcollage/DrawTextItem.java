...
// The String that is drawn by this item.
...
// magnification won't apply to border
...
* backgroundTransparency the background transparency level, in the range 0 to 1

* IllegalArgumentException if the parameter is less than 0 or greater than 1
...
* IllegalArgumentExceptionif the parameter is less than 0 or greater than 1
...
throw new IllegalArgumentException("Transparency must "
